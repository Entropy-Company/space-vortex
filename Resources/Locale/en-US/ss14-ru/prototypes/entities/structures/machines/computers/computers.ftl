...
ent-ComputerSecureRecords = secure records computer
    .desc = This can be used to check secure records. Only security can modify them.
ent-ComputerStationRecords = station records computer
    .desc = This can be used to check station records.
ent-ComputerLaborRecords = station labor computer
    .desc = This can be used to check labor records.
