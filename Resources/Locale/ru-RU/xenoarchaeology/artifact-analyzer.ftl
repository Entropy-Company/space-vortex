...
analysis-console-extract-none = [font="Monospace" size=11][color=orange] Ни на одном из разблокированных узлов не осталось точек для извлечения [/color][/font]
analysis-console-extract-sum = [font="Monospace" size=11][color=orange]Итоговые исследования: { $value }[/color][/font]
