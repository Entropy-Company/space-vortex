...
cmd-unlocknode-help = Разблокируйте узел <artifact uid> <node uid>
...
artifact-unlock-state-end-success = Он замедляется, явно изменившись.  
artifact-unlock-state-end-failure = Он замедляется, но без каких-либо событий останавливается.
...
artifact-node-class-6 = [color=#be78ff]Демиургический[/color]
