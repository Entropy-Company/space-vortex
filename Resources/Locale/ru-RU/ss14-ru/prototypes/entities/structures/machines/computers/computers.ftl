...
ent-ComputerLaborRecords = консоль трудового учёта
    .desc = По нему можно проверять трудовые записи.
...
ent-ComputerCargoOrdersSecurity = консоль заказов отдела безопасности
...
ent-ComputerSalvageJobBoard = консоль утилизаторских заданий.
    .desc = Консоль для доступа к заданиям по спасению, если ты достаточно смелый.
