...
ent-PlushieExperiment = плюшевый эксперимент
    .desc = Плюшевая игрушка, напоминающая собачьего рода существо, жаждущая взорваться на мине.
...
ent-PlushieXeno = плюшевый эксо
    .desc = Очаровательная мягкая игрушка, напоминающая страшного эксоморфа. Вам повезло, что это всего лишь игрушка.
