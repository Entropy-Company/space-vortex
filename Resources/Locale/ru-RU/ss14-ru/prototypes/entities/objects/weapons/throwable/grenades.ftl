...
ent-AirGrenade = воздушная граната
    .desc = Специальная химическая граната в твердом состоянии, предназначенная для быстрого выпуска стандартного воздуха в замкнутое пространство. Заполняет до 30 клеток!
