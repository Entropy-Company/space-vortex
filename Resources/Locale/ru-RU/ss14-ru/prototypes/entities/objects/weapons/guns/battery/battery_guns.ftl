...
ent-WeaponTemperatureGun = термальный пистолет
    .desc = Продвинутый пистолет, стреляющий лучами, меняющими температуру тела. Скорее всего, это можно считать военным преступлением.
ent-XenoborgLaserGun = лазерный пистолет эксоборга
    .desc = { ent-WeaponAdvancedLaser.desc }
ent-XenoborgHeavyLaserGun = тяжёлый лазерный пистолет эксоборга
    .desc = { ent-WeaponAdvancedLaser.desc }
