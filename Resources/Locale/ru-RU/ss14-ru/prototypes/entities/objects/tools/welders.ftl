...
ent-RefuelingWelder = сварочный аппарат с авто-дозаправкой
    .desc = Медленный сварочный аппарат, который может со временем пополнять собственный запас топлива.
