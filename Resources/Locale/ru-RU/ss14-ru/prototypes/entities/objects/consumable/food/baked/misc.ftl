...
ent-FoodBakedGrilledCheeseSandwichCotton = бутерброд с плавленым сыром на хлопковой булочке
    .desc = Хлопковый хлеб слегка поджарен на масле с расплавленным сыром. Мотылькам трудно устоять перед этим сочетанием.