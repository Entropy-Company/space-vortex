...
ent-FoodBreadMeatXeno = хлеб из эксо-мяса
    .desc = Успокаивающе зелёный рулет из мяса эксоса. Крайне еретичен.
ent-FoodBreadMeatXenoSlice = ломтик хлеба из эксо-мяса
