...
ent-ClothingNeckCloakAdmin = вех!-плащ
    .desc = Вех!
ent-ClothingNeckCloakSalvagerSupreme = плащ Великого утилизатора
    .desc = Носится самыми искусными утилизатор — теми, кто покорил космос и сделал астероид для добычи своим владением. Такие плащи просто так не раздают, знаешь ли.
