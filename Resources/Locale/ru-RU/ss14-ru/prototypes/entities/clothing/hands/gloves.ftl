...
ent-ClothingHandsKnuckleDusters = кастеты
    .desc = Холодные кастеты из пластали, делают твои удары намного мощнее.
ent-ClothingHandsKnuckleDustersBrass = латунные кастеты
    .desc = Латунные кастеты, как их делали раньше, и они всё ещё наносят такой же сильный урон.
ent-ClothingHandsKnuckleDustersQM = золотые кастеты КМ
    .desc = 24-каратное золото с примесью пластали, украшенное логотипом NanoTrasen. Истинный символ силы Квартирмейстера.
ent-ClothingHandsKnuckleDustersSyndicate = кастеты синдиката
    .desc = Кастеты из пластитаниума с кроваво-красной буквой S. Настоящий мужик может ими убить врага.
ent-ClothingHandsKnuckleDustersStun = оглушающие кастеты
    .desc = Кастеты с технологией электрошокера. С такими избивать нарушителей гораздо проще.
