...
ent-ClothingBackpackDebug = баговый рюкзак
    .desc = Что это, черт возьми, такое?
    .suffix = Отладка
ent-ClothingBackpackDebug2 = большой баговый рюкзак
    .desc = Что это, черт возьми, такое?
    .suffix = Отладка
ent-ClothingBackpackDebug3 = странный баговый рюкзак
    .desc = Что это, черт возьми, такое?
    .suffix = Отладка
ent-ClothingBackpackDebug4 = смещённый баговый рюкзак
    .desc = Что это, черт возьми, такое?
    .suffix = Отладка