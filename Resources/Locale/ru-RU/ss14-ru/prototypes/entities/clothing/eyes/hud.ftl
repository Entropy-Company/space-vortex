...
ent-ClothingEyesHudFriedOnion = очки "жареный лук"
    .desc = Заполнитель
ent-ClothingEyesHudOnionBeer = очки "тунгерст"
    .desc = Заполнитель
ent-ClothingEyesHudMedOnion = медонион хед-ап дисплей
    .desc = Заполнитель
ent-ClothingEyesHudMedOnionBeer = медтунгерст хед-ап дисплей
    .desc = Заполнитель
...
ent-ClothingEyesHudMultiversal = мульти-вселенский визор
    .desc = Filler
...
ent-ClothingEyesEyepatchHudDiag = диагностический моновизор
    .desc = Окуляр с индикатором на стекле, способный анализировать целостность и состояние роботов и экзокостюмов. Сделан из си-боргия.
ent-ClothingEyesEyepatchHudDiagFlipped = диагностическая повязка с HUD (зеркальная)
