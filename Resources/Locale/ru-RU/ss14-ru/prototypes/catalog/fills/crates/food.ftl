...
ent-CrateFoodGetMore = Контейнер Getmore Bakemore
    .desc = Закуски и выпечка бренда Getmore для творческого повара, без необходимости опустошать автоматы Getmore на вашей станции!
ent-CrateFoodIceCream = доставка мороженого
    .desc = Ассорти мороженого для любого случая! Включает 16 замороженных угощений.
ent-CrateFoodSnowcone = доставка снежных конусов
    .desc = Морозильник, заполненный освежающими снежными конусами для усердной или даже ленивой команды! Включает 16 снежных конусов.
ent-CrateFoodHappyHonkBigBite = доставка еды Happy Honk
    .desc = Два полноценных сета Happy Honk Big Bite, с сырным картофелем фри, бутылкой Space Cola, кусочком яблочного пирога и игрушкой!
