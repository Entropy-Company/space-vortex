...
ent-CrateMaterialGold = контейнер с золотом
    .desc = 30 слитков золота.
ent-CrateMaterialSilver = контейнер с серебром
...
ent-CrateMaterialSilo = контейнер с складом материалов
    .desc = Пакет, включающий все материалы для создания склада для материалов.
ent-CrateMaterialBasicResource = контейнер с базовыми листами
