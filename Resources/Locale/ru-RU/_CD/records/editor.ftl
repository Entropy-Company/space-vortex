...
# Безопасность
humanoid-profile-editor-cd-records-identifying-features = Идентифицирующие особенности:

# Медицина
humanoid-profile-editor-cd-records-allergies = Аллергии:
humanoid-profile-editor-cd-records-drug-allergies = Аллергии на препараты:
humanoid-profile-editor-cd-records-postmortem = Инструкции на случай вскрытия:
...
cd-records-entry-default-title = Без названия
...
cd-records-entry-edit-popup-involved-required = Требуется указать автора(ов)
cd-records-entry-edit-popup-description-required = Требуется указать описание
cd-records-entry-edit-popup-description-too-long = Слишком длинное описание! ({$current}/{$max} символов)
