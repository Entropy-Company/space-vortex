...
namespace Content.Server.VendingMachines
{
    public sealed class VendingMachineSystem : SharedVendingMachineSystem
    {
        ...
        public override void Initialize()
        {
            ...
            SubscribeLocalEvent<VendingMachineComponent, DamageChangedEvent>(OnDamage); //Economy
        ...
        private void OnDamage(EntityUid uid, VendingMachineComponent component, DamageChangedEvent args) //Economy
        {
        ...
        public bool IsAuthorized(EntityUid uid, EntityUid sender, VendingMachineComponent? vendComponent = null)
        {
            ...
            Popup.PopupEntity(Loc.GetString("vending-machine-component-try-eject-access-denied"), uid, sender); //Economy
