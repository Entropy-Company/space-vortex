    ...
    public sealed partial class CargoSystem
    {
        ...
        private void UpdateConsole()
        {
            ...
            while (stationQuery.MoveNext(out var uid, out var bank))
            {
                ...
                Logger.Info($"[CargoSystem] UpdateConsole: uid={uid}, IncreasePerSecond={bank.IncreasePerSecond}, IncomeDelay={bank.IncomeDelay}, RevenueDistribution.Count={bank.RevenueDistribution.Count}");
                ...
                {
                    Logger.Error($"[CargoSystem] Exception in UpdateBankAccount for entity {uid}: {ex}");
                }
            }
        }
